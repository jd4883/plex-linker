...
The **unpackerr** project is defined in `homelab/helm/core/argocd/terraform/argocd-config/configs/config.yaml` (core repo):

- **path:** `"."` (chart root)
- **sourceRepo:** `git@github.com:jd4883/homelab-unpackerr.git`
